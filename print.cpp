...
template <typename... Types> void printDoubled(Types const &...args) {
  print(args + args...);
}

template <typename... Types> void addOne(Types const &...args) {
  print(1 + args...);
}
...
template <size_t... Idx, typename C> void printIdx(C const &coll) {
  print(coll[Idx]...);
}
